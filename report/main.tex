...
\input{./modules/theoreticalBackground}
\input{./modules/programUsage}
\input{./modules/groupManagement}
\input{./modules/programStructure}
\input{./modules/backend}
\input{./modules/frondend}
