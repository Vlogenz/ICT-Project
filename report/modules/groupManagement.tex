...
This separation was not strict; members often helped out in the other domain when bottlenecks appeared. This flexibility allowed us to utilize the full capacity of the team without being limited by rigid role definitions. As Individuals we had different capacities for this project and could contribute different amounts to different times. Eventough there is a discrepancy in the amount each member contributed, we all agree that the project should be graded as a whole, and each member receives the same grade.
