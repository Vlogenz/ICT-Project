...
In the the ZIP-File we providede there is an executable file named \texttt{CircuitQuest.exe} for Windows users. Linux and Mac users need to build the application from source.
